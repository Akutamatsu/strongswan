...
#define mlex_params_H_

#include <crypto/key_exchange.h>

typedef struct mlex_kem_params_t mlex_kem_params_t;
 ...
 * values.
 */
extern const uint16_t mlex_kem_zetas[128];
